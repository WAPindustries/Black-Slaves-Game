class Game{
	...
	static aChoices = [
		[
		    ["Implement child labour laws", ()=>Succeed(-4e+4)],
		    ["Force all children to drop out of school", ()=>Fail(+25e+4)],
		    ["Invest in investigative journalism", ()=>Succeed(-18e+4)],
		],
		[
		    ["Improve access to education", ()=>Succeed(-15e+4)],
		    ["Legalise child labour", ()=>Succeed(-4e+4)],
		    ["Give more sweets to experienced kidnappers", ()=>Fail(+10e+4)],
		],
		[
		    ["Increase enforcement of child labour laws", ()=>Succeed(-18e+4)],
		    ["Execute all existing parents", ()=>Fail(+30e+4)],
		    ["Cut off children's arms", ()=>Fail(+1e+4)],
		],
		[
		    ["Promote social protection programmes in rural areas in India", ()=>Succeed(-18e+4)],
		    ["Legalise child labour", ()=>Succeed(-4e+4)],
		    ["Ask online influencers to talk about child labour in India", ()=>Succeed(-1e+4)],
		],
		[
		    ["Start a war", ()=>Fail(+15e+4)],
		    ["Educate parents about the negative impacts of child labour", ()=>Succeed(-4e+4)],
		    ["Educate consumers about ethical purchasing decisions", ()=>Succeed(-11e+4)],
		]
	]
	...
	static iSpawnRate = 2**(Game.aChoices.length+1)
	static SpawnNiggers(){
