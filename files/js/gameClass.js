class Game{
	...
	static aChoices = [
		[
			["Consumer education to make ethical purchasing decisions", ()=>
				Succeed(7e+6, 1e+4,
			...
			["Bring in more children from other districts", ()=>Fail(11e+6, 1e+3)],
			["Force children to drop out of school", ()=>Fail(11e+6, 1e+3)],
		],

		[
			["Reduce taxes if companies do not employ child labour", ()=>
				Succeed(Game.iNiggers-4e+6, 1e+4,
					["Companies are attracted to increase profits by less taxes rather than by cheap labour."]
				)
			],
			["Schools were destroyed due to landslide", ()=>Fail(13e+6, 1e+3)],
			["Remove child labour laws", ()=>Fail(13e+6, 1e+3)]
		],

		[
			["Stricter enforcement of child labour laws", ()=>Succeed(Game.iNiggers-3e+6, 1e+4, [])],
			["Execute all parents", ()=>Fail(15e+6, 1e+3)],
			["Establish policies that favour child labour", ()=>Fail(15e+6, 1e+3)],
		]
	]
